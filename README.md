...
> [!WARNING]
> ## Auto-script Artificial Intelligence disclaimer:
> 
> The majority of the code by this point is generated by AI (claude), in the sense that it gives me a lump of somewhat functioning code, then I comb through it manually and telling it to fix stuff, to the point that I can comprehend and explain what each chunk of code does, with the notable exception of the python code, whitch I barely understand. In my defence, apart from the script generation + patching sequence, most of the code is case structures for menus, and simple file generation/manipulation
